                ...
                <div class="row align-items-center py-0">
                    <div class="col-12 col-md-7 col-lg-6 pb-4 my-5 justify-content-center">
                        <div class="card bg-light mt-5 p-5 offset-md-2" style="width: 30rem;">
                            <c:choose>
                                <c:when test="${requestScope.get(RegistrationAuthorCommand.ERROR_CODE).equals(RegistrationAuthorCommand.EMAIL_ERROR_VALUE)}">
                            ...
                            <form class="form-horizontal">
                                <h3 class="text-center font-weight-bold">
                                    <fmt:message key="label.registration"/></h3>
                                <label class="pt-2 my-0" for="nameAuthor">
                                    <fmt:message key="label.name"/></label>
                                <input type="text" class="form-control" id="nameAuthor"
                                       name="${RegistrationAuthorCommand.USER_NAME}" required>
                                <label class="pt-2 my-0" for="emailAuthor">
                                    <fmt:message key="label.email"/></label>
                                <input type="email" class="form-control" id="emailAuthor"
                                       name="${RegistrationAuthorCommand.USER_EMAIL}" required>
                                <label class="pt-2 my-0" for="phoneAuthor">
                                    <fmt:message key="label.phone"/></label>
                                ...
                                <textarea class="form-control" id="documentsAuthor" rows="4"
                                          name="${RegistrationAuthorCommand.USER_ADDITIONAL_INFO}"></textarea>
                                <br>
