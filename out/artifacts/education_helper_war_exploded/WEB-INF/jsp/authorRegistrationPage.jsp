                ...
                <div class="col-12 col-md-7 col-lg-6 pb-4 my-5 justify-content-center">
                    <div class="card bg-light mt-5 p-5 offset-md-2" style="width: 30rem;">
                        <form class="form-horizontal">
                            <h3 class="text-center font-weight-bold"><fmt:message
                                    key="registrationPage.label.registration"/></h3>
                            <label class="pt-2 my-0" for="nameAuthor"><fmt:message
                                    key="registrationPage.label.name"/></label>
                            <input type="text" class="form-control" id="nameAuthor"
                                   name="${RegistrationUserCommand.USER_NAME}" required>
                            <label class="pt-2 my-0" for="emailAuthor"><fmt:message
                                    key="registrationPage.label.email"/></label>
                            <input type="email" class="form-control" id="emailAuthor"
                                   name="${RegistrationUserCommand.USER_EMAIL}" required>
                            <label class="pt-2 my-0" for="phoneAuthor"><fmt:message
                                    key="registrationPage.label.phone"/></label>
                            ...
                            <div class="col text-center">
                                ...
                                <input class="btn btn-rounded mb-4 purple-gradient" type="submit"
                                       onclick="message('<fmt:message key="registrationPage.message.msgAfterSend"/>')"
                                       value="<fmt:message key="registrationPage.button.send"/>">
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-12 col-md-7 col-lg-6">
                    <div class="col">
                        <h3 class="text-center font-weight-bold text-white"><fmt:message
                                key="registrationPage.label.authorHead"/></h3>
                            ...
                            <div class="col">
                                <a href="#" class="btn btn-info btn-rounded mb-4 purple-gradient"
                                   data-toggle="modal" data-target="#modalContacts"><fmt:message
                                        key="registrationPage.button.call"/></a>
                            </div>
                        </div>
                    </div>
                </div>
